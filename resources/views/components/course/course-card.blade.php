    ...
    <a href="{{ route('course.show', $course->id) }}" class="block relative overflow-hidden">
        @php
            ...
            if (isset($course->coursedetails[0]) && preg_match('/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/', $course->coursedetails[0]->content ?? '', $match)) {
                $videoId = $match[1];
                $thumbnailUrl = "https://img.youtube.com/vi/{$videoId}/maxresdefault.jpg"; // Sử dụng maxresdefault để tăng chất lượng
            }
        @endphp
        ...
        <div class="absolute top-3 right-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md">
    ...
    <div class="p-5 flex-1 flex flex-col">
        <div class="flex-1">
            ...
            <div class="flex items-center text-sm text-gray-600 mb-3">
                ...
                <span>Lớp {{ $course->grade ?? 'Chưa có cấp lớp' }}</span>
            </div>
            ...
            <div class="flex items-center mb-3">
                ...
                <span class="text-xs text-gray-500 ml-1">(25 đánh giá)</span>
            </div>
