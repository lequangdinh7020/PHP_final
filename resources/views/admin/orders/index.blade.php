    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="mt-4 md:mt-0">
            <div class="flex items-center space-x-3">
                <a href="#" class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors flex items-center">
    ...
    <div class="p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="flex items-center space-x-4">
                <div class="relative">
                    <input type="text" placeholder="Tìm kiếm đơn hàng..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 w-full md:w-64">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <div class="flex items-center">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500">Đơn hàng chưa thanh toán</p>
                <p class="text-2xl font-bold text-gray-900">{{ $orderDetails->where('order.status', '!=', 1)->count() }}</p>
            </div>
        </div>
    </div>
