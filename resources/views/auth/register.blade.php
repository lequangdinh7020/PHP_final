<x-guest-layout>
    <div class="min-h-screen flex flex-col md:flex-row">
        <!-- Left side - Image -->
        <div class="hidden md:block md:w-1/2 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80')">
            <div class="h-full w-full bg-gradient-to-r from-indigo-900/90 to-blue-900/70 flex items-center justify-center p-12">
                <div class="max-w-xl">
                    <h2 class="text-4xl font-bold text-white mb-6">Bắt đầu hành trình học tập</h2>
                    <p class="text-xl text-white/90 mb-8">Tạo tài khoản để truy cập hàng ngàn khóa học chất lượng cao từ các giảng viên hàng đầu.</p>
        ...
        <div class="w-full md:w-1/2 bg-gradient-to-b from-gray-50 to-white flex items-center justify-center p-6 md:p-12 relative">
            <div class="w-full max-w-md">
                ...
                <h2 class="text-3xl font-bold text-gray-800 text-center mb-2">Đăng ký tài khoản</h2>
                <p class="text-gray-600 text-center mb-8">Tạo tài khoản mới để bắt đầu hành trình học tập</p>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Name -->
                    <div>
                        <x-input-label for="name" :value="__('Họ và tên')" class="text-gray-700 font-medium text-sm mb-2" />
                        <div class="relative">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Nguyễn Văn A" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="email@example.com" />
                        </div>
                    ...
                    <!-- Password -->
                    <div>
                        <x-input-label for="password" :value="__('Mật khẩu')" class="text-gray-700 font-medium text-sm mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <x-text-input id="password" class="block mt-1 w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
                        </div>
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <x-input-label for="password_confirmation" :value="__('Xác nhận mật khẩu')" class="text-gray-700 font-medium text-sm mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            ...
                            <x-text-input id="password_confirmation" class="block mt-1 w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
                        </div>
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('login') }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium transition duration-150">
                                {{ __('Đăng nhập') }}
                            </a>
                        </div>
                    </div>
